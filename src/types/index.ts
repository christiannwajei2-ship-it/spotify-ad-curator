...
export type AppStep = 'landing' | 'analyzing' | 'dashboard' | 'targeting' | 'ad-generator' | 'history' | 'analytics' | 'pricing' | 'scheduler' | 'reels-studio' | 'demo-hub' | 'notification-settings';
